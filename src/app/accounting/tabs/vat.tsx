...
interface VatReturnItem {
  ...
  dueWarning: string;
  isOverdue: boolean;
  status: 'Overdue' | 'Filed On Time' | 'Filed Late' | 'Draft' | 'Not Required';
  payable: string;
  refund: string;
  filedDate: string;
}

const INITIAL_RETURNS: VatReturnItem[] = [
  {
    id: '1',
    initials: 'AB',
    avatarBg: '#7C2D12',
...
export default function VatTab() {
  ...
  const filterOptions = {
    status: ['All', 'Overdue', 'Filed On Time', 'Filed Late', 'Draft', 'Not Required'],
    period: ['All', 'Apr 2026', 'Mar 2026', 'Feb 2026', 'Jan 2026'],
    zone: ['All', 'Mainland', 'Free Zone'],
  ...
  const filteredReturns = INITIAL_RETURNS.filter(item => {
    ...
    const matchesZone = filters.zone === 'All' || item.type === filters.zone;
    // (mock manager filtering or matches default if needed)
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ margin: '0.5rem 0 0', fontSize: '0.875rem', color: 'rgba(42,22,40,0.6)' }}>
            Track VAT returns, filings, payments and compliance across all clients.
          </p>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: '0.75rem' }}>
        {[
          { label: 'VAT Returns Due', value: '9', sub: '+3 this week', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /><line x1="16" y1="13" x2="8" y2="13" /><line x1="16" y1="17" x2="8" y2="17" /></svg>, bg: '#FAF2EC', border: '#F3DEC9' },
          { label: 'Returns Overdue', value: '3', sub: '-1 vs last week', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2" /><line x1="12" y1="8" x2="12" y2="12" /><line x1="12" y1="16" x2="12.01" y2="16" /></svg>, bg: '#FAF2EC', border: '#F3DEC9' },
          { label: 'Filed This Month', value: '21', sub: '+6 vs last week', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="20 6 9 17 4 12" /></svg>, bg: '#FAF2EC', border: '#F3DEC9' },
          { label: 'Refunds Due', value: '5', sub: 'AED 38,450', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="12" y1="1" x2="12" y2="23" /><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /></svg>, bg: '#FAF2EC', border: '#F3DEC9' },
          { label: 'Total Output Tax', value: 'AED 812,450', sub: 'This Month', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /></svg>, bg: '#FAF2EC', border: '#F3DEC9' },
          { label: 'Total Input Tax', value: 'AED 618,230', sub: 'This Month', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /></svg>, bg: '#FAF2EC', border: '#F3DEC9' },
          { label: 'Net VAT Payable', value: 'AED 194,220', sub: 'This Month', icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="7" width="20" height="14" rx="2" ry="2" /><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" /></svg>, bg: '#FAF2EC', border: '#F3DEC9' },
        ].map((card, i) => (
          <div key={i} style={{
            background: '#ffffff',
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.3fr 1fr', gap: '1.25rem' }}>
        ...
        <div style={{ background: '#ffffff', border: '1px solid rgba(42,22,40,0.06)', borderRadius: '16px', padding: '1.5rem', boxShadow: '0 4px 12px rgba(42,22,40,0.02)' }}>
          <h3 style={{ fontSize: '0.9rem', fontWeight: 700, color: '#2A1628', margin: '0 0 1.25rem', fontFamily: 'var(--font-sans), Inter, sans-serif' }}>VAT Filing Status Overview</h3>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '150px' }}>
            <div style={{ position: 'relative', width: '120px', height: '120px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg width="120" height="120" viewBox="0 0 36 36" style={{ transform: 'rotate(-90deg)' }}>
                <circle cx="18" cy="18" r="15.915" fill="none" stroke="#2A1628" strokeWidth="3.2" strokeDasharray="100 0" />
              ...
              <div style={{ position: 'absolute', textAlign: 'center' }}>
                ...
                <div style={{ fontSize: '0.625rem', color: 'rgba(42,22,40,0.5)', marginTop: '2px' }}>Total Returns</div>
              </div>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem', flex: 1, marginLeft: '1.5rem' }}>
              {[
                ...
                { name: 'Draft', val: '28', pct: '11%', color: '#8B6D83' },
        ...
        <div style={{ background: '#ffffff', border: '1px solid rgba(42,22,40,0.06)', borderRadius: '16px', padding: '1.5rem', boxShadow: '0 4px 12px rgba(42,22,40,0.02)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
            <h3 style={{ fontSize: '0.9rem', fontWeight: 700, color: '#2A1628', margin: 0, fontFamily: 'var(--font-sans), Inter, sans-serif' }}>VAT Payable Trend</h3>
            <div style={{ position: 'relative' }}>
              <button
                onClick={() => setTrendRangeOpen(o => !o)}
                style={{
                  display: 'flex', alignItems: 'center', gap: '0.35rem',
                  border: '1px solid #DDD0C4', borderRadius: '8px',
              ...
              {trendRangeOpen && (
                <div style={{
                  ...
                  {['Last 6 Months', 'Last Year', 'Current Year'].map(opt => (
                    <div
                      key={opt}
                      onClick={() => { setTrendRange(opt); setTrendRangeOpen(false); }}
                      style={{
                        padding: '0.5rem 0.75rem', fontSize: '0.75rem', cursor: 'pointer',
                        color: trendRange === opt ? '#E8760A' : '#2A1628',
                        background: trendRange === opt ? 'rgba(232,118,10,0.06)' : 'transparent',
                        fontWeight: trendRange === opt ? 600 : 400
                      }}
                      onMouseEnter={e => { if (trendRange !== opt) e.currentTarget.style.background = 'rgba(232,118,10,0.04)'; }}
                      onMouseLeave={e => { if (trendRange !== opt) e.currentTarget.style.background = 'transparent'; }}
                    >
                      {opt}
                    </div>
                  ))}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', height: '175px', justifyContent: 'space-between', position: 'relative' }}>
            ...
            <div style={{ position: 'relative', flex: 1, width: '100%', borderBottom: '1px solid rgba(42,22,40,0.08)' }}>
              ...
              <svg width="100%" height="110px" viewBox="0 0 300 100" preserveAspectRatio="none">
                <path d="M10,65 L60,40 L120,50 L180,30 L240,48 L290,25" fill="none" stroke="#E8760A" strokeWidth="2.5" />
                {/* Dots on line */}
                <circle cx="10" cy="65" r="3.5" fill="#E8760A" stroke="#fff" strokeWidth="1" />
                <circle cx="60" cy="40" r="3.5" fill="#E8760A" stroke="#fff" strokeWidth="1" />
                <circle cx="120" cy="50" r="3.5" fill="#E8760A" stroke="#fff" strokeWidth="1" />
                <circle cx="180" cy="30" r="3.5" fill="#E8760A" stroke="#fff" strokeWidth="1" />
                <circle cx="240" cy="48" r="3.5" fill="#E8760A" stroke="#fff" strokeWidth="1" />
                <circle cx="290" cy="25" r="3.5" fill="#E8760A" stroke="#fff" strokeWidth="1" />
              </svg>
            </div>
        ...
        {/* VAT Return Status List (Right Column) */}
        <div style={{ background: '#ffffff', border: '1px solid rgba(42,22,40,0.06)', borderRadius: '16px', padding: '1.5rem', boxShadow: '0 4px 12px rgba(42,22,40,0.02)' }}>
          <h3 style={{ fontSize: '0.9rem', fontWeight: 700, color: '#2A1628', margin: '0 0 1.25rem', fontFamily: 'var(--font-sans), Inter, sans-serif' }}>VAT Return Status</h3>
            ...
            {[
              ...
              <div key={idx} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: idx < 4 ? '1px solid rgba(42,22,40,0.04)' : 'none', paddingBottom: '0.4rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem' }}>
                  <span style={{ fontWeight: 700, color: '#2A1628' }}>{item.val}</span>
                  <span style={{ color: 'rgba(42,22,40,0.4)' }}>({item.pct})</span>
                </div>
              </div>
            ))}
          </div>
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', flex: 1, minWidth: '180px' }}>
          ...
          <input
            type="text"
            placeholder="Search client or VAT No..."
            value={search}
            ...
            <div key={f.key} style={{ position: 'relative' }}>
              <button
                ...
                style={{
                  ...
                  fontFamily: 'inherit',
                  justifyContent: 'space-between',
                  minWidth: f.key === 'status' ? '120px' : f.key === 'period' ? '120px' : f.key === 'zone' ? '110px' : '110px'
                }}
              >
        ...
        <button
          onClick={() => setFilters({ status: 'All', period: 'All', zone: 'All', manager: 'All' })}
          style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ fontSize: '0.8125rem', color: 'rgba(42,22,40,0.6)' }}>Showing 1 to 10 of 248 VAT returns</span>
        </div>
        ...
        <div className="client-table-scroll" style={{
          ...
          boxShadow: '0 4px 12px rgba(42,22,40,0.01)'
            ...
            `}</style>
            <table style={{ width: '100%', minWidth: '1150px', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.8125rem' }}>
              <thead>
                <tr style={{ background: '#FAF8F5', borderBottom: '1px solid rgba(42,22,40,0.06)', color: 'rgba(42,22,40,0.5)', fontWeight: 600, whiteSpace: 'nowrap' }}>
                  ...
                  <th style={{ padding: '1rem' }}>VAT NO.</th>
                  <th style={{ padding: '1rem' }}>RETURN PERIOD</th>
                  <th style={{ padding: '1rem' }}>DUE DATE</th>
                  <th style={{ padding: '1rem' }}>STATUS</th>
                  <th style={{ padding: '1rem', textAlign: 'right' }}>VAT PAYABLE (AED)</th>
                  <th style={{ padding: '1rem', textAlign: 'right' }}>REFUND (AED)</th>
                  <th style={{ padding: '1rem' }}>FILED DATE</th>
                ...
                {filteredReturns.map((item, idx) => (
                  <tr key={item.id} style={{
                    ...
                    <td style={{ padding: '1rem', whiteSpace: 'nowrap' }}>
                      <div style={{ fontWeight: 600, color: item.isOverdue ? '#D32F2F' : '#2A1628' }}>{item.dueDate}</div>
                      {item.dueWarning && (
                        <div style={{ fontSize: '0.65rem', color: '#D32F2F', fontWeight: 700, marginTop: '0.125rem' }}>{item.dueWarning}</div>
                      )}
                    </td>
                    ...
                    <td style={{ padding: '1rem', whiteSpace: 'nowrap' }}>
                      <span style={{
                        ...
                        borderRadius: '4px',
                        background: item.status === 'Overdue' ? '#FEE2E2'
                          : item.status === 'Filed On Time' ? '#E6F4EA'
                          : item.status === 'Filed Late' ? '#FFE0B2'
                          : item.status === 'Draft' ? '#E8F0FE' : '#F1F3F4',
                        color: item.status === 'Overdue' ? '#D32F2F'
                          : item.status === 'Filed On Time' ? '#137333'
                          : item.status === 'Filed Late' ? '#E65100'
                          : item.status === 'Draft' ? '#1A73E8' : '#5F6368'
                      }}>{item.status}</span>
                    </td>
                    ...
                    {/* Refund */}
                    <td style={{ padding: '1rem', textAlign: 'right', fontWeight: 600, color: item.refund !== '-' ? '#10B981' : '#2A1628', whiteSpace: 'nowrap' }}>
                      {item.refund}
                    </td>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem', marginTop: '0.5rem' }}>
        ...
        <div style={{ background: '#ffffff', border: '1px solid rgba(42,22,40,0.06)', borderRadius: '16px', padding: '1.25rem', boxShadow: '0 4px 12px rgba(42,22,40,0.02)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', fontSize: '0.75rem' }}>
            {[
              { name: 'ABC Trading LLC', returnPeriod: 'Apr 2026 Return', date: '28 May 2026', badge: 'Due in 2 Days', overdue: true },
              { name: 'XYZ Holdings Limited', returnPeriod: 'Apr 2026 Return', date: '28 May 2026', badge: 'Due in 2 Days', overdue: true },
              { name: 'Delta Properties FZCO', returnPeriod: 'May 2026 Return', date: '15 Jun 2026', badge: 'Due in 20 Days', overdue: false },
              { name: 'Alpha Tech FZCO', returnPeriod: 'May 2026 Return', date: '15 Jun 2026', badge: 'Due in 20 Days', overdue: false },
              { name: 'Beta Industries LLC', returnPeriod: 'May 2026 Return', date: '15 Jun 2026', badge: 'Due in 20 Days', overdue: false }
            ].map((item, idx) => (
              <div key={idx} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: idx < 4 ? '1px solid rgba(42,22,40,0.04)' : 'none', paddingBottom: '0.4rem' }}>
                <div>
                  <div style={{ fontWeight: 600, color: '#2A1628' }}>{item.name}</div>
                  <div style={{ fontSize: '0.65rem', color: 'rgba(42,22,40,0.45)', marginTop: '0.125rem' }}>{item.returnPeriod}</div>
                </div>
                <div style={{ textAlign: 'right' }}>
                  <div style={{ fontWeight: 600, color: '#2A1628', fontSize: '0.7rem' }}>{item.date}</div>
                  <div style={{ fontSize: '0.65rem', color: item.overdue ? '#2A1628' : '#E8760A', fontWeight: 700, marginTop: '0.125rem' }}>{item.badge}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* VAT Compliance Health Gauge */}
        <div style={{ background: '#ffffff', border: '1px solid rgba(42,22,40,0.06)', borderRadius: '16px', padding: '1.25rem', boxShadow: '0 4px 12px rgba(42,22,40,0.02)' }}>
          <h4 style={{ fontSize: '0.85rem', fontWeight: 700, color: '#2A1628', margin: '0 0 1rem', fontFamily: 'var(--font-sans), Inter, sans-serif' }}>VAT Compliance Health</h4>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.75rem' }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <div style={{ position: 'relative', width: '200px', height: '110px', overflow: 'hidden', display: 'flex', justifyContent: 'center' }}>
                <svg width="200" height="200" viewBox="0 0 36 36" style={{ transform: 'rotate(-180deg)', position: 'absolute', top: 0 }}>
                  ...
                  <circle cx="18" cy="18" r="15.915" fill="none" stroke="#E8760A" strokeWidth="3.5" strokeDasharray="39 61" />
                </svg>
                <div style={{ position: 'absolute', bottom: 0, textAlign: 'center' }}>
                  <div style={{ fontSize: '2.5rem', fontWeight: 700, color: '#2A1628', lineHeight: 1 }}>78%</div>
            ...
            <div style={{ width: '100%', maxWidth: '320px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '0.85rem', fontSize: '0.9rem' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: '0.2rem' }}>
                ...
                <strong style={{ color: '#2A1628', fontWeight: 600 }}>30 <span style={{ color: 'rgba(42,22,40,0.4)', fontWeight: 400 }}>(12%)</span></strong>
              </div>
            </div>
          </div>
        </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 700, color: '#2A1628' }}>VAT Compliance Calendar</h3>
              </div>
              <button
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', maxHeight: '350px', overflowY: 'auto', paddingRight: '4px' }}>
              {[
                { name: 'ABC Trading LLC', trn: '100556789600003', period: 'Apr 2026', due: '28 May 2026', status: 'Pending', color: '#E8760A' },
                { name: 'XYZ Holdings Limited', trn: '100223344500001', period: 'Apr 2026', due: '28 May 2026', status: 'Overdue', color: '#C4695A' },
                { name: 'Delta Properties FZCO', trn: '100987654300002', period: 'May 2026', due: '15 Jun 2026', status: 'Draft', color: 'rgba(42,22,40,0.5)' },
                { name: 'Alpha Tech FZCO', trn: '100778899000005', period: 'May 2026', due: '15 Jun 2026', status: 'Pending', color: '#E8760A' },
                { name: 'Beta Industries LLC', trn: '100445566100008', period: 'May 2026', due: '15 Jun 2026', status: 'Filed', color: '#047857' }
              ].map((item, idx) => (
                <div key={idx} style={{
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: '0.7rem', color: 'rgba(42,22,40,0.45)', marginTop: '0.15rem' }}>TRN: {item.trn} • Period: {item.period}</div>
                  </div>
                  <div style={{ textAlign: 'right' }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 700, color: '#2A1628' }}>Generate VAT Reports</h3>
              </div>
              <button
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 700, color: '#2A1628' }}>Add New VAT Return</h3>
              </div>
              <button
            ...
            <p style={{ margin: 0, fontSize: '0.8125rem', color: 'rgba(42,22,40,0.6)' }}>
              Log a new VAT filing cycle details for compliance tracking.
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.9rem' }}>
                    ...
                    {['ABC Trading LLC', 'XYZ Holdings Limited', 'Delta Properties FZCO', 'Alpha Tech FZCO', 'Beta Industries LLC'].map(c => (
                      <div
                        ...
                        onClick={() => {
                          ...
                          if (c.includes('XYZ')) nextTrn = '100223344500001';
                          if (c.includes('Delta')) nextTrn = '100987654300002';
                          if (c.includes('Alpha')) nextTrn = '100778899000005';
                          if (c.includes('Beta')) nextTrn = '100445566100008';
              ...
              {/* Flex row for Period and Due Date */}
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                {/* Period */}
                <div style={{ position: 'relative' }}>
                  <label style={{ display: 'block', fontSize: '0.7rem', fontWeight: 600, color: 'rgba(42,22,40,0.5)', textTransform: 'uppercase', marginBottom: '0.3rem' }}>Return Period</label>
                  <button
                  ...
                  {modalPeriodOpen && (
                    <div style={{
                      ...
                      {['May 2026', 'Jun 2026', 'Jul 2026', 'Aug 2026'].map(p => (
                        <div
                          key={p}
                          onClick={() => {
                            let nextDue = '28 Jun 2026';
                            if (p.includes('Jun')) nextDue = '28 Jul 2026';
                            if (p.includes('Jul')) nextDue = '28 Aug 2026';
                            if (p.includes('Aug')) nextDue = '28 Sep 2026';
                            setNewReturnForm({ ...newReturnForm, period: p, dueDate: nextDue });
                            setModalPeriodOpen(false);
                          }}
                          style={{
                            padding: '0.45rem 0.65rem', fontSize: '0.75rem', color: '#2A1628',
                            cursor: 'pointer', borderRadius: '6px',
                            background: newReturnForm.period === p ? 'rgba(232, 118, 10, 0.06)' : 'transparent',
                            fontWeight: newReturnForm.period === p ? 600 : 400
                          }}
                        >
                          {p}
                        </div>
                ...
                {/* Due Date */}
                <div>
                  <label style={{ display: 'block', fontSize: '0.7rem', fontWeight: 600, color: 'rgba(42,22,40,0.5)', textTransform: 'uppercase', marginBottom: '0.3rem' }}>Due Date</label>
                  <input
                    type="text"
              ...
              {/* Flex row for Payable and Refund */}
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                <div>
                  <label style={{ display: 'block', fontSize: '0.7rem', fontWeight: 600, color: 'rgba(42,22,40,0.5)', textTransform: 'uppercase', marginBottom: '0.3rem' }}>Payable (AED)</label>
                  <input
                    type="number"
                    value={newReturnForm.payable}
                    onChange={e => setNewReturnForm({ ...newReturnForm, payable: e.target.value, refund: '' })}
                    placeholder="0.00"
                    style={{ width: '100%', border: '1px solid #DDD0C4', borderRadius: '8px', padding: '0.6rem 0.85rem', fontSize: '0.8125rem', background: '#FAF8F5', color: '#2A1628', outline: 'none', boxSizing: 'border-box', fontFamily: 'inherit' }}
                  />
                </div>
                <div>
                  <label style={{ display: 'block', fontSize: '0.7rem', fontWeight: 600, color: 'rgba(42,22,40,0.5)', textTransform: 'uppercase', marginBottom: '0.3rem' }}>Refund (AED)</label>
                  <input
                    type="number"
                    value={newReturnForm.refund}
                    onChange={e => setNewReturnForm({ ...newReturnForm, refund: e.target.value, payable: '' })}
                    placeholder="0.00"
                    style={{ width: '100%', border: '1px solid #DDD0C4', borderRadius: '8px', padding: '0.6rem 0.85rem', fontSize: '0.8125rem', background: '#FAF8F5', color: '#2A1628', outline: 'none', boxSizing: 'border-box', fontFamily: 'inherit' }}
                  />
                </div>
